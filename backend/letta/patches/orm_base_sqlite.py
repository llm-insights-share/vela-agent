...
class CommonSqlalchemyMetaMixins(Base):
    ...
    # SQLite-compatible defaults: func.now() becomes literal "now()" under create_all on SQLite
    ...
    is_deleted: Mapped[bool] = mapped_column(Boolean, server_default=text("0"), default=False)
